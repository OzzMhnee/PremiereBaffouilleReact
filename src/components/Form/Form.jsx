...
class Form extends Component {
    ...
    handleSubmitForm = e  => {
        e.preventDefault();
        console.log(`Username: ${TouchList.state.username}) Couleur : ${this.state.color} Comment : ${this.state.comment}`)
    }
        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSubmitForm}>
                    <div>
                        <label> Pseudo</label>
                        <input type="text" value={this.state.username} onChange={this.handlePsedo}/>
                    </div>
                    <div>
                        <label> Couleur</label>
                        <select value={this.state.color} onChange={this.handleColor}>
                            {this.state.colors.map((color, idx) => (
                                <option hey={idx} value={color}>{color}</option>
                            ))}
                        </select>
                    </div>
                    <div>
